...
export default function Card() {
  ...
  return (
    <div className="main-card">
      <img
        className="img-card"
        src="https://img.freepik.com/free-vector/global-earth-blue-technology-digital-background-design_1017-27075.jpg"
        alt="alternate"
      />
      ...
      <p className="summary-card">
        The Amazing Spiderman has been spotted recently in Mysuru. It was seen that
